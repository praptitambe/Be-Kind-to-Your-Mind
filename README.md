...
- **Navbar**
  ...
  *Expanded Navbar*
  ![Navbar Expanded](assets/documentation/expanded-navbar.png)
...
- **Grid Display**
  ...
  - A grid display was my priority. It ensured that everything would be displayed neatly and, with the help of media queries, responsively.
    ...
    ![Desktop Events Grid](assets/documentation/challenges.png)

    ![Tablet Events Grid](assets/documentation/tab-grid.png)

    ![Mobile Events Grid](assets/documentation/mobile-grid.png)
...
![Desktop Home Top](assets/documentation/desktop-home-top.png)

![Desktop Home Bottom](assets/documentation/desktop-home-bottom.png)
...
![Tablet Home Top](assets/documentation/tab-home-top.png)

![Tablet Home Bottom](assets/documentation/tab-home-bottom.png)
...
![Mobile Home Top](assets/documentation/mobile-home-top.png)

![Mobile Home Bottom](assets/documentation/mobile-home-bottom.png)
...
![Project Board](assets/documentation/project-board.png)


## Testing

- HTML validation
![Home page validation](assets/documentation/home-page.png)
![Kindness page validation](assets/documentation/kindness.png)
![Mindfulness page validation](assets/documentation/mindfulness.png)
![Sleep page validation](assets/documentation/sleep.png)
![Anxiety page validation](assets/documentation/anxiety.png)
![Contact page validation](assets/documentation/contact.png)

- CSS validation
![Stylesheet validation](assets/documentation/stylsheet-validation.png)

- Lighthouse Report
![Stylesheet validation](assets/documentation/lighthouse.png)
